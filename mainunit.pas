...
begin
  ...
  case SmoothingMode of
    MODE_MOVING_AVERAGE: begin
      MovingAverageMethod(Y, SmoothedY, MovingAverageSpan.Position);
    end;
    MODE_SIMPLE_EXPONENTIAL: begin
      SimpleExponentialMethod(Y, SmoothedY, ExponentialSpan.Position / 10);
    end;
    MODE_MEDIAN: begin
...
procedure TMainForm.MovingAverageMethod(const InputData: TDoubleArray; var OutputData: TDoubleArray; const Span: Integer);
...
procedure TMainForm.SimpleExponentialMethod(const InputData: TDoubleArray;
...
procedure TMainForm.MedianMethod(const InputData: TDoubleArray;
